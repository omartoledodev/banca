...
>
  <head>
    ...
    <!-- Icons -->
    <link rel="stylesheet" href="/css/vendor/fonts/fontawesome.css" />
    <link rel="stylesheet" href="/css/vendor/fonts/tabler-icons.css" />
    <link rel="stylesheet" href="/css/vendor/fonts/flag-icons.css" />

    <!-- Core CSS -->
    <link rel="stylesheet" href="/css/vendor/css/rtl/core.css" class="template-customizer-core-css" />
    <link rel="stylesheet" href="/css/vendor/css/rtl/theme-default.css" class="template-customizer-theme-css" />
    <link rel="stylesheet" href="/css/vendor/css/demo.css" />

    <!-- Vendors CSS -->
    <link rel="stylesheet" href="/css/vendor/libs/perfect-scrollbar/perfect-scrollbar.css" />
    <link rel="stylesheet" href="/css/vendor/libs/node-waves/node-waves.css" />
    <link rel="stylesheet" href="/css/vendor/libs/typeahead-js/typeahead.css" />
    <link rel="stylesheet" href="/css/vendor/libs/apex-charts/apex-charts.css" />
    <link rel="stylesheet" href="/css/vendor/libs/swiper/swiper.css" />
    <link rel="stylesheet" href="/css/vendor/libs/datatables-bs5/datatables.bootstrap5.css" />
    <link rel="stylesheet" href="/css/vendor/libs/datatables-responsive-bs5/responsive.bootstrap5.css" />
    <link rel="stylesheet" href="/css/vendor/libs/datatables-checkboxes-jquery/datatables.checkboxes.css" />

    <!-- Page CSS -->
    <link rel="stylesheet" href="/css/vendor/css/pages/cards-advance.css" />
    <!-- Helpers -->
    <script src="/css/vendor/js/helpers.js"></script>

    <!--! Template customizer & Theme config files MUST be included after core stylesheets and helpers.js in the <head> section -->
    <!--? Template customizer: To hide customizer set displayCustomizer value false in config.js.  -->
    <script src="/css/vendor/js/template-customizer.js"></script>
    <!--? Config:  Mandatory theme config file contain global vars & default theme options, Set your preferred theme option in this file.  -->
    <script src="/css/vendor/js/config.js"></script>
  </head>
  ...
  <body>
    ...
    <script src="/css/vendor/libs/jquery/jquery.js"></script>
    <script src="/css/vendor/libs/popper/popper.js"></script>
    <script src="/css/vendor/js/bootstrap.js"></script>
    <script src="/css/vendor/libs/perfect-scrollbar/perfect-scrollbar.js"></script>
    <script src="/css/vendor/libs/node-waves/node-waves.js"></script>

    <script src="/css/vendor/libs/hammer/hammer.js"></script>
    <script src="/css/vendor/libs/i18n/i18n.js"></script>
    <script src="/css/vendor/libs/typeahead-js/typeahead.js"></script>

    <script src="/css/vendor/js/menu.js"></script>
    <!-- endbuild -->

    <!-- Vendors JS -->
    <script src="/css/vendor/libs/apex-charts/apexcharts.js"></script>
    <script src="/css/vendor/libs/swiper/swiper.js"></script>
    <script src="/css/vendor/libs/datatables-bs5/datatables-bootstrap5.js"></script>
